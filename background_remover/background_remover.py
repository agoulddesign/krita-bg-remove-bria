...
class BackgroundRemover(QDockWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Background Remover BreaAI")
    ...
    def load_api_key(self):
        app = Krita.instance()
        api_key = app.readSetting("BackgroundRemoverBreaAI", "api_key", "")
        self.api_key_input.setText(api_key)

    def save_api_key(self):
        app = Krita.instance()
        app.writeSetting("BackgroundRemoverBreaAI", "api_key", self.api_key_input.text())
...
Application.addDockWidgetFactory(
    DockWidgetFactory("background_remover",
